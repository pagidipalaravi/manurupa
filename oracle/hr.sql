...
DROP TABLE "HR"."PS_TXN" cascade constraints;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."PS_TXN_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 50 START WITH 1101 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
REM INSERTING into HR.PS_TXN
SET DEFINE OFF;
Insert into HR.PS_TXN (ID,PARENTID,COLLID,CREATION_DATE) values (1,-1,101,to_date('04-11-21','DD-MM-RR'));
...
--------------------------------------------------------
  ...
  CREATE INDEX "HR"."PS_TXN_IDX" ON "HR"."PS_TXN" ("COLLID", "ID") REVERSE 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."PS_TXN" ADD CONSTRAINT "PS_TXN_PK" PRIMARY KEY ("COLLID", "ID")
